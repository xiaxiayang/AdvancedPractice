 ...
 * 设置 header 和 footer 的 demo 类
 */
public class HeaderAndFooterActivity extends BaseRvActivity {
    ...
    protected void initView() {
        ...
        headerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(HeaderAndFooterActivity.this, "I am a Header", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void bindEvent() {
        ...
        adapter.setOnItemClickListener(new HeaderAndFooterAdapter.onItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Toast.makeText(HeaderAndFooterActivity.this, dataBeanList.get(bodyPosition).getData(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void  showSettingLayoutMangerDialog(){
        ...
        tvLinear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                rvCommon.setLayoutManager(new LinearLayoutManager(HeaderAndFooterActivity.this));
                adapter.notifyDataSetChanged();
        ...
        tvGrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                rvCommon.setLayoutManager(new GridLayoutManager(HeaderAndFooterActivity.this,2));
